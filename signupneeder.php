        ...
        <div class="login-container">
            ...
            <div class="panel welcome-panel">
                <div class="content-wrapper">
                    <h1 class="welcome-title">Iwant to be a helper</h1>
                    <p class="welcome-text">welcome to or platform we want to thank u for your concern</p>
                </div>
            ...
            <div class="panel form-panel">
                <form action="welcom.php" method="POST">
                    ...
                    <div class="input-group">
                        <i class="fas fa-lock icon"></i>
                        <input type="text" name="docID" placeholder="ID-Number" minlength="10" maxlength="10"required>
                    </div>
